...
\begin{frame}
    ...
    Why is it possible in such high dimensions?
...
def f(x):
    ...
    \begin{itemize}
        ...
        \item can automatically specialize to CPU / GPU / TPU 
    \end{itemize}
...
\begin{frame}
    ...
    \vspace{0.5em}
    Can be used for deep learning \underline{or} mathematical modeling
...
\begin{frame}
    ...
    \begin{itemize}
        \item runs on \$10K mainframe with 356 CPUs and 1TB RAM
